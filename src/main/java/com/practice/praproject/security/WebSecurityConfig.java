 ...
 * 这些方法将会被AnnotationConfigApplicationContext或AnnotationConfigWebApplicationContext类进行扫描，并
 * 用于构建bean定义，初始化Spring容器。
 */
@Configuration
/**
 * @EnableWebSecurity1:
 * 加载了WebSecurityConfiguration配置类, 配置安全认证策略。加载了AuthenticationConfiguration, 配置了认证信息。
 */
@EnableWebSecurity
/**
